...
if not os.path.exists('/Users/ernestng/Desktop/projects/bookLSTM/scrapedata/test_data.csv'):
    ...
    book_data.to_csv(
        '/Users/ernestng/Desktop/projects/bookLSTM/scrapedata/test_data.csv')
    ...
    try:
        ...
        if i % save_every == 0:
            book_data.append(pd.DataFrame.from_dict(book_rows)).to_csv(
                '/Users/ernestng/Desktop/projects/bookLSTM/scrapedata/test_data.csv', index=False)
            book_rows = []
    except:
        book_data.append(pd.DataFrame.from_dict(book_rows)).to_csv(
            '/Users/ernestng/Desktop/projects/bookLSTM/scrapedata/test_data.csv', index=False)
